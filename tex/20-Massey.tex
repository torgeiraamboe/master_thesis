...
Recall that a DG-algebra $A$ is called formal\index{Formal DG-algebra} there is a span of quasi-isomorphism $H(A)\leftarrow C \rightarrow A$ for some DG-algebra $C$. 
